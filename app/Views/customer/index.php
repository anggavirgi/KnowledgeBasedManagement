        ...
        <!-- <div id="faq" class="flex justify-center w-full">
            <div class="grid justify-items-center mt-[40px]">
                ...
                <div class="relative flex justify-center items-center" id="search">
                    <form action="">
                        <input type="text" name="email" id="email" placeholder="Search Your question, answer, etc" class="sm:w-[30rem] w-[25rem] mt-2 mb-5 px-7 mt-[30px] py-3 rounded-[15px] border border-gray-400 outline-main">
                        <button>
