...
<body class="text-sm">
    <section class="navbar bg-white py-4 sm:px-24 px-[10px] drop-shadow-md">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-4 items-center font-medium">
                ...
                <?php  else : ?>
                    <a href="/kb/login" class="p-2 whitespace-nowrap hover:text-main">Sign In</a>
                    <a href="/kb/register" class="bg-main text-white rounded-md px-4 py-2 whitespace-nowrap hover:bg-blue-500">Sign Up</a>
                <?php  endif; ?>
            </div>
        </div>
    </section>
