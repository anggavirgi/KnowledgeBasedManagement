...
<div class="border-2 border-gray-200 bg-white p-7 rounded shadow-md text-sm">
    <h2 class="font-bold text-xl">List Project</h2>
    <div class="flex justify-between items-center my-5">
        ...
        <div class="flex items-center gap-4">
            <div class="delete-batch hidden">
                <button type="button" class="delete-batch-btn inline-block px-4 py-2 border border-white hover:border-red-600 rounded-2xl bg-red-500 hover:bg-red-600" data-action="/kb/administrator/project/deleteBatch">
            ...
            <a href="<?php echo base_url(); ?>kb/administrator/project/new" class="border border-gray-400 px-6 py-2 rounded-2xl hover:border-green-400 cursor-pointer">
    ...
    <table class="w-full text-center" id="myTable">
        <thead class="border-b">
            <tr>
                ...
                <th class="p-3 w-64">Project Name</th>
        ...
        <tbody>
            <?php foreach ($projects as $project) : ?>
                <tr class="border-b hover:bg-gray-50">
                    <td class="p-3" data-id="<?php echo $project['id'] ?>">
                        <input type="checkbox" class="delete-checkbox" name="" id="">
                    </td>
                    <!-- <td class="p-3">1</td> -->
                    <td class="p-3"><?php echo $project['name_project'] ?></td>
                    <td class="p-3 text-center">
                        <a href="<?php echo base_url() ?>kb/administrator/project/edit/<?= $project['id']; ?>" class="px-2 inline-block">
                        ...
                        <button type="button" class="btn-delete px-2 inline-block" data-id="<?= $project['id']; ?>" data-action="/kb/administrator/project/delete/<?= $project['id']; ?>" title="delete">
