    ...
    <div class="flex items-center justify-between mt-5 mb-3" id="search">
        ...
        <div class="flex gap-3">
            <div class="delete-batch hidden">
                <button type="button" class="delete-batch-btn inline-block px-4 py-2 border border-white hover:border-red-600 rounded-2xl bg-red-500 hover:bg-red-600" data-action="/kb/administrator/complain/deleteBatch">
