...
<div class="border-2 border-gray-200 bg-white p-7 rounded shadow-md text-sm">
    ...
    <div class="flex items-center justify-between mt-5 mb-3" id="search">
        ...
        <div class="flex gap-3">
            <a href="<?php echo base_url(); ?>kb/administrator/article/editarticle" class="border border-gray-400 px-6 py-2 rounded-2xl hover:border-green-400 cursor-pointer">
