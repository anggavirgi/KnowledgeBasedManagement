            ...
            <tbody>
                <?php foreach ($articles as $article) : ?>
                    <tr class="border-b hover:bg-gray-50 dark:hover:bg-sky-50">
                        ...
                        <td class="p-3">
                            <?php echo $article['id_category'] ?>
                        </td>
                        <td class="p-3">
                            <?php echo $article['id_sub_category'] ?>
                        </td>
                        <td class="p-3">
                            Project
                        </td>
                        ...
                        <td class="p-3 text-center">
                            <a href="<?php echo base_url() ?>kb/administrator/article/detail/<?php echo $article['id'] ?>" class="px-2 inline-block" title="detail">
                            ...
                            <a href="<?php echo base_url(); ?>kb/administrator/article/edit/<?php echo $article['id'] ?>" class="px-2 inline-block" title="edit">
                            ...
                            <button type="button" class="btn-delete px-2 inline-block" data-id="<?= $article['id']; ?>" data-action="/kb/administrator/article/delete/<?= $article['id']; ?>" title="delete">
