...
<div class="bg-white w-1090 h-[40rem] rounded shadow-md ">
    <div class="p-8">
        <div class="text-[#565656] text-[1.5rem] font-bold ">User List</div>
        <div class="flex items-center justify-between" id="search">
            <form action="">
                <input type="text" name="email" id="email" placeholder="Search" class="sm:w-[20rem] w-[25rem] mt-2 mb-5 px-7 mt-[30px] py-3 rounded-[15px] border border-gray-400 outline-main">
                <button class="relative">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="absolute right-5 bottom-0 bi bi-search cursor-pointer text-[#919191]" viewBox="0 0 16 16">
                        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                </button>
                </svg>
            </form>
            <div class="flex gap-2">
                <div class="rounded-[15px] border-[#8E8E8E] border-2 px-5 py-2  ">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 cursor-pointer">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z" />
                    </svg>
                </div>
                <div class="rounded-[15px] border-[#8E8E8E] border-2 px-7 py-2  "> Export
                </div>
            </div>
        </div>
        <div class="mb-4 flex items-center justify-end">
            ...
            <div class="relative">
                <select id="entries" class=" appearance-none border-[#8E8E8E] border-2 py-2 px-6 cursor-pointer rounded-[15px] text-gray-700 focus:outline-none focus:border-blue-500">
                ...
                <tbody>
                    <tr class="border-b hover:bg-gray-50 dark:hover:bg-sky-50">
                        ...
                        <td class="px-6 py-4 flex">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" class="w-6 h-6 stroke-secondary">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                            </svg>

                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="#A30D11" class="w-6 h-6">
