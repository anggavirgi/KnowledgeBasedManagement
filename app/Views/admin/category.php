      ...
      <?php foreach ($categories as $category) : ?>
        <tr class="border-b hover:bg-gray-50">
          ...
          <td class="p-3 text-center">
            <a href="<?php echo base_url() ?>kb/administrator/category/subcategory/<?= $category['id']; ?>" class="px-2 inline-block" title="sub-category">
            ...
            <button type="button" class="btn-delete px-2 inline-block" data-id="<?= $category['id']; ?>" data-action="/kb/administrator/category/delete/<?= $category['id']; ?>" title="delete">
